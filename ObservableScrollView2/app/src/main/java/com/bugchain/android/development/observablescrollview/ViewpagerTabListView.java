...
public class ViewpagerTabListView extends ActionBarActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewpager_tab_list_view);

 //       setSupportActionBar((Toolbar) findViewById(R.id.toolbar));

        mHeaderView = findViewById(R.id.header);
        ViewCompat.setElevation(mHeaderView, getResources().getDimension(R.dimen.toolbar_elevation));
        mToolbarView = findViewById(R.id.iii);
    ...
    private static class NavigationAdapter extends FragmentStatePagerAdapter {
        ...
        private static final String[] TITLES = new String[]{"Applepie", "Butter Cookie", "Cupcake", "Donut"};
